...
import { NEWSLETTER_SIGNUP_VISIBLE, type NewsletterCopy } from "@/lib/newsletter";
  ...
  return (
    <footer className="mt-auto border-t border-stone-200/70 bg-[#f3efe8]/80 py-10 sm:py-12">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        {NEWSLETTER_SIGNUP_VISIBLE && newsletterCopy ? (
          <>
        ...
        <p
          className={
            NEWSLETTER_SIGNUP_VISIBLE && newsletterCopy
              ? "mt-10 text-center text-sm text-stone-500"
